    ...
    function locationSuccess(position) {
        ...
        try{
            ...
            if(cache && cache.timestamp && cache.timestamp > d.getTime() - 30*60*1000){
                ...
                var weatherAPI = 'http://api.openweathermap.org/data/2.5/forecast?APPID=841738b63489bc8b86b86531ec928213&lat='+position.coords.latitude+'&lon='+position.coords.longitude+'&callback=?'
